...
import { cilList, cilFilterPhoto, cilSave, cibBuffer } from "@coreui/icons";
        ...
        <AuthenticatedLayout
            header={
                <h2 className="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200 panel-title">
                    <CIcon className='text-success' icon={cibBuffer} /> Gestion des bulletins | <strong className="badge bg-light shadow-sm rounded border text-danger">{trimestre.libelle}</strong>
                </h2>
            }
        >
