        ...
        <AuthenticatedLayout
            header={
                <h2 className="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200 panel-title">
                    <CIcon className='text-success' icon={cibBuffer} /> Insertion d'interrogations groupées
                </h2>
            }
        >
                        ...
                        <div className="bg-light p-3 rounded border mb-5">
                            {checkPermission('interrogation.view') ?
                                (<div className=" text-center  items-center gap-4">
                                    <Link className="btn btn-sm bg-success bg-hover text-white" href={route("interrogation.index")}> <CIcon icon={cilList} /> Liste des intérrogations</Link>
                                </div>) : null
                            }
