        ...
        <AuthenticatedLayout
            header={
                <h2 className="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200 panel-title">
                    <CIcon className='text-success' icon={cibBuffer} /> Moyennes des devoirs | Trimestre: <strong className="badge bg-light shadow-sm rounded border text-danger">{trimestre.libelle}</strong> | Année scolaire: <strong className="badge bg-light shadow-sm rounded border text-danger">{annee_scolaire || '---'}</strong>
                </h2>
            }
        >
